...
4. V1.1 尚未由 Mata老師核准前，V1.0 仍是正式執行規格。
5. V1.1 生效後，若與 V1.0 的「日常工具責任」衝突，以 V1.1 為準；故事鎖定、QC、Exact Asset、版本控制及人工 Gate 等品質規則仍完整繼承 V1.0。
...
**END OF ARCHITECTURE V1.1｜DRAFT**
